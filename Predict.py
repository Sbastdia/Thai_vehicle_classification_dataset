...
model = scratch_nn()
model.load_state_dict = torch.load('/content/PracticaCoches/thaiVehicles.pth',map_location ='cpu')
model.eval()
...
labels = ["Car", "Bus", "Taxi", "Bike", "Pickup", "Truck", "Trailer"]

for image_path in glob.glob("/content/PracticaCoches/train/images/*.jpg"):
