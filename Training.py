...
class ThaiVehiclesDataset(Dataset):
...
# Create dataloaders
train_dir = '/content/PracticaCoches/train/images/'
images_paths1 = os.listdir(train_dir)
random.shuffle(images_paths1)
...
lr = 0.001
weight_dec = 0.001
model_file_name = "thaiVehicles.pth"
